      ...
      <div className="flex gap-8">
        ...
        <div className="relative group w-fit mx-auto cursor-pointer">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            {/* Middle text */}
            <div className="flex gap-2 text-base md:text-xl font-semibold text-[var(--secondary)]">
        ...
        <div className="relative group w-fit mx-auto cursor-pointer">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            {/* Middle text */}
            <div className="flex gap-6 text-base md:text-xl font-semibold text-[var(--secondary)]">
