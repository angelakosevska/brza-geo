...
export default function Welcome({ onStart }) {
  return (
    <LetterBackground>
      <div className="w-full min-h-screen flex items-center justify-center text-text px-4">
        <GlassCard className="mt-16 w-full max-w-[90vw] max-h-[90vh] min-h-[90vh] flex flex-col md:flex-row gap-6 p-8">
          {/* Left side - Buttons */}
